"""Clean twin of 014: a rectangular parcel, centroid inside it.

Same question, same districts, but the parcel is convex — so the centroid
falls where the parcel is, and locating by centroid gives the right district.
"""
