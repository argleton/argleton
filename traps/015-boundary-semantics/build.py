"""Build two districts that partition the study area, and wells on the seam.

West is x in [0, 50], east is x in [50, 100]: together they cover everything,
and they share the line x = 50. Four of the twelve wells sit exactly on that
line. Every well is in the study area — the districts leave no gap — so the
answer is 12 whichever district each seam well is assigned to.
"""
...
def main(destination: Path) -> int:
    ...
    wells = [
        ...
        (50, 20), (50, 40), (50, 60), (50, 80),  # exactly on the shared edge
    ]
    gpd.GeoDataFrame(
